install clerk into my project from here i want you to check for the presence then you wire it to the nextjs app and , redirection routes and user menu

## design
When it comes to the design i want you to use the 'clerk's' dark theme from '@clerk/ui/themes' as the base


override clerk's appearnce variables using the app's existing css variables. Do not Hardcode colors


## signin and signup rules 
Note that modify the existing signin and signuo screeen to meetup with these requirement
