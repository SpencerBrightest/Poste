    ...
    <div className="dashboard-shell">
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          <section className="dashboard-insight"><div className="insight-icon"><Sparkles size={18} /></div><div><strong>Keep your momentum going, {displayName}</strong><p>Your Facebook audience is growing fastest this week. Schedule your next post for Thursday at 6:00 PM.</p></div><Link className="insight-action" href="/editor/advisor">View advisor <ChevronRight size={15} /></Link><button className="insight-more" type="button" onClick={() => showNotice("Insight options opened")} aria-label="More insight options"><MoreHorizontal size={17} /></button></section>
        </div>
      </main>
